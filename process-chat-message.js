Hooks.on('ready', () => {
    ...
    function run() {
        ...
        console.log("PROCESS-CHAT-MESSAGE:Enabled")
                        ...
                        'roll': {
                            ...
                            <ul>
                                ...
                                let chatData = await roll.toMessage({
                                    ...
                                    flavor: `<h1><span>Defend</span> </h1>${game.i18n.localize("fate-core-official.RolledBy")}: ${game.user.name}<br>
                                            ${extraFlavor}
                                            <button class='show-defend-journal' style='margin-bottom:10px'>Show Defend Options</button>
                                            `,
                                    speaker: msg
                                }, {
                                    create: true
